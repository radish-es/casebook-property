...
| 13 | Feb 25/27 |  [Mid-Term Rapid Review]({{< ref "problems/review03"  >}})  | [Holmes, "The Path of Law"]({{< ref "secondary/holmes"  >}}) <br/> | 
| 14 | Mar 4/6 |  [Possession, Revisited]({{< ref "lessons/week14"  >}})  | [Keefer v Arillotta]({{< ref "cases/keefer"  >}}) <br/> [Kosicki v Toronto (City)]({{< ref "cases/kosicki"  >}}) <br/> [Popov v Hayashi]({{< ref "cases/popov"  >}}) <br/> |
| 15 | Mar 11/13 |  [Reserve Lands in Transition]({{< ref "lessons/week15"  >}})  | [Guerin v R]({{< ref "cases/guerin"  >}}) <br/> [*Indian Act*]({{< ref "statutes/indian-act"  >}}) <br/> [Rise of the FNLM Regime]({{< ref "secondary/fnlma-yellowhead"  >}}) <br/> [*Southwind v Canada*]({{< ref "cases/southwind"  >}}) <br/> |
