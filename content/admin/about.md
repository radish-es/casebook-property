...
but a good starting point and working definition for our purposes is: "*respected relationships between people with regard to land and sometimes to other 'things'.*" Our focus is on property as it has emerged and changed in the Anglo-Canadian tradition, often in relation to other legal traditions which it encounters and---more than we acknowledge--on which it often depends.
...
Now that you understanding a bit of the basic architecture for this course, you should review the [Coursebook User Manual](../user-manual). This will provide you with a step-by-step guide to navigating the different sections and organizational components of the book as you engage with the reading materials and prepare for our twice weekly meetings.
