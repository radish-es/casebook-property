...
Abandonment occurs when property--once established by possession or other legal means--is voluntarily given up by the owner. Abandonment requires the owner to demonstrate an express *intention* to permanently abandon their property rights: they must have “the intention of terminating ownership, possession and control” [^manning2008] along with the actual relinquishment of control.
...
However, there is a different rule with respect to wild animals (animals *ferae naturae*). Property in these animals can be established through first possession, but that property is "*lost*" again as soon as the animal escapes its owner's control, irrespective of what the owner intends. In this way, possessory rights in wild animals establish only a contingent form of property--unlike property in inanimate objects, which remains intact even if an object is lost or misplaced and insofar as it is not intentionally abandoned.
