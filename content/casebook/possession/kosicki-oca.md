---
type: case
title: Kosicki v Toronto (City) [OCA]
short: Kosicki
reporter: 2023 ONCA 450 (CanLII)
year: 2023
facts: A private owner claims adverse possession of municipal parkland in Toronto.
description: A private owner claims adverse possession of municipal parkland in Toronto.
issue: 
held: 
public: true
sources: 
...
## *Kosicki v Toronto (City), 2025 SCC 28 (CanLII)*

On appeal to the Supreme Court of Canada, the majority agreed in part with Justice Brown's dissenting opinion, allowing the appeal and finding that Ontario's *RPLA* operated as a "complete code" dealing with exceptions to adverse possession claims. The Court determined that the Court of Appeal's decision had attempted to usurp the legislative intent behind the *RPLA* and wrongly extended the common law "public benefit test" to municipal parkland. A vigorous dissent at the Supreme Court agreed with the Court of Appeal's majority decision and would have applied the public benefit test described by Justice Sossin to dismiss the appeal. 

The majority wrote:

> In this case, the majority of the Court of Appeal declined to apply the *RPLA* on the basis that the rationales justifying the existence of the doctrine of adverse possession do not support its application to municipal parkland (paras. 16-19). It posited that "it is difficult to identify *any* rationale for adverse possession against municipal parkland" (para. 20 (emphasis in original)). The City has largely reasserted this argument before this Court (R.F., at paras. 93 et seq.).
>
...
For the dissenting justices' part, they wrote:
